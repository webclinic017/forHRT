...
namespace cAlgo.Robots
{
    ...
    public class LDSTradingSystem : Robot
    {
        ...
        protected override void OnTick()
        {
            ...
            var BuyStopLossInPips = Math.Round(_simpleMovingAverage.Result.Last(1) * Symbol.TickValue, Symbol.Digits);
            var SellStopLossInPips = Math.Round(_simpleMovingAverage.Result.Last(1) * Symbol.TickValue, Symbol.Digits);
